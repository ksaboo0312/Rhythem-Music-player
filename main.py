...
# using try and except block
    try:
        ...
        if playing == False:
            ...
            status.set('Playing - '+str(file.split('.mp3')[0]))
...
# function for about
def about():
    mb.showinfo('Rhythem', 'It is the basic music player with some advance feature made in Python.😎\nIt is created by Keshav Saboo with ❤.\nIt is completed on 25/04/2023.\nThanks for using the application.👍')
...
if __name__ == '__main__':
    ...
    status.set('❤Welcome to you  in the world of Music❤')
